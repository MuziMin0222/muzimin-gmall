...
export default {
  ...
  methods: {
    addCatelogSelect() {
      ...
      this.$http({
        url: this.$http.adornUrl('/categorybrandrelation/save'),
        method: 'post',
    ...
    deleteCateRelationHandle(id, brandId) {
      this.$http({
        url: this.$http.adornUrl('/categorybrandrelation/delete'),
        method: 'post',
    ...
    getCateRelation() {
      this.$http({
        url: this.$http.adornUrl('/categorybrandrelation/catelog/list'),
        method: 'get',
